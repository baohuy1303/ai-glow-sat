            ...
            <div className="min-h-screen bg-[#E9E8F5] flex flex-col items-center justify-start py-16">
                ...
                <div className="flex gap-8 mb-12">
                    <button
                        ...
                        className="bg-[#6210E8] text-white font-semibold text-lg px-8 py-3 rounded-full hover:bg-[#520bcf] transition"
                    >
                        Custom Test
                    </button>
                    <button
                ...
                <div className="w-full flex flex-col items-center space-y-10 mb-20">
                    ...
                    <div className="bg-white rounded-2xl w-11/12 md:w-3/4 p-10 text-center">
                        ...
                        <p className="text-lg text-black">
                            ...
                            Smarter, faster, and more personalized SAT prep —
                    ...
                    <div className="bg-[#CBB8D6] rounded-2xl w-11/12 md:w-3/4 p-10 text-center">
                        ...
                        <p className="text-lg text-black">
                            AI Glow was created to solve a simple problem: most
                            online test prep tools are outdated, expensive, and
                            one-size-fits-all. We believe students deserve
                            better — and we’re using AI to build it.
                            <br />
                            We’re dedicated to redefining SAT prep through
                            innovation and inclusivity, making high-quality
                    ...
                    <div className="bg-[#CBB8D6] rounded-2xl w-11/12 md:w-3/4 p-10 text-center">
                        ...
                        <p className="text-lg text-black">
                            Affordable plans for every student — start learning
                            for free, and upgrade for access to premium tools
                            and analytics.
                        </p>
                    </div>
                    {/* Support */}
                    <div className="bg-white rounded-2xl w-11/12 md:w-3/4 p-10 text-center">
                        ...
                        <p className="text-lg text-black">
                            Have questions? Need help navigating the site? Email
                            us at support@aiglow.edu for information.
                        </p>
                    </div>
                </div>
            </div>
